...
CREATE TABLE IF NOT EXISTS documentos_evento (
    ...
    nombre_archivo VARCHAR(255) DEFAULT 'documento.pdf',
    contenido_base64 LONGTEXT NULL,
    nombre_archivo_generado VARCHAR(255) NULL,
    ruta_archivo_generado VARCHAR(500) NULL,
    nombre_archivo_firmado VARCHAR(255) NULL,
    ruta_archivo_firmado LONGTEXT NULL,
    mime_type VARCHAR(100) NOT NULL DEFAULT 'application/pdf',
    visible_publico BOOLEAN NOT NULL DEFAULT FALSE,
    fecha_generacion DATETIME NULL,
    fecha_subida_firmado DATETIME NULL,
    generado_por_cuenta_id BIGINT NULL,
    subido_por_cuenta_id BIGINT NULL,
    created_at DATETIME NOT NULL DEFAULT CURRENT_TIMESTAMP,
    updated_at DATETIME NOT NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP,
    FOREIGN KEY (evento_id) REFERENCES eventos(id) ON DELETE CASCADE,
